...
var ground, invisibleGround, groundImage, gameState,  gameOver, restart, gameOverImage, restartImage;
...
function setup() {
  ...
  gameOver=createSprite(300,100,10,30);
  gameOver.addImage("over",gameOverImage);
    
  restart=createSprite(300,150,20,50);
  restart.addImage("reestart",restartImage);
